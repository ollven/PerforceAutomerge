...
object Artifact1 : BuildType({
    ...
    artifactRules = """
        2024-12-23 15.33.26.jpg => ima ges
        2024-12-23 15.33.45.jpg => ima ges
    """.trimIndent()
...
object Artifact2 : BuildType({
    ...
    artifactRules = "filetoconflict1.txt => fi les"
...
object Composite : BuildType({
    ...
    dependencies {
        artifacts(Artifact1) {
            ...
            artifactRules = "ima ges => ima ges"
        }
        artifacts(Artifact2) {
            buildRule = lastSuccessful()
            artifactRules = "fi les => fi les"
        }
    }
})
